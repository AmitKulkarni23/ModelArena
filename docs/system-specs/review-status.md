...
|----------|--------|------|-------|
| HLD | DONE | 2026-06-24 | POC scope, 2 Lambdas, no persistence, SSE streaming, free-tier judges |
| LLD: Models Lambda | DONE | 2026-06-24 | API contract, cache design, filter logic, error handling |
